...
public class ErrorDetail
{
    ...
    {
        //////////////////////////////////////sys start//////////////////////////////////////
        error_detail_map.put(ErrorCodeDef.RET_SYS_DISCON_USER_KICKED,"此账号在另一处登录了");
        error_detail_map.put(ErrorCodeDef.RET_UNPACK_FAILED_RESULT,"服务器解包失败");
        ...
        error_detail_map.put(ErrorCodeDef.RET_SYS_PACK_TYPE_INVALID,"服务异常，请稍后再试");
        error_detail_map.put(ErrorCodeDef.RET_SYS_REPEAT_LOGINED,"此账号已登录");
        error_detail_map.put(ErrorCodeDef.RET_REG_FAILED,"注册失败");
        error_detail_map.put(ErrorCodeDef.RET_INVALID_VERITY_CODE,"无效的验证码");
        error_detail_map.put(ErrorCodeDef.RET_VERIFY_CODE_FREQUENCY,"验证码获取太频繁");
        //////////////////////////////////////sys end///////////////////////////////////////
        ...
        error_detail_map.put(ErrorCodeDef.RET_NEW_MOBILE_BASE,"新手机号码不能与旧手机号码相同");
        error_detail_map.put(ErrorCodeDef.RET_CHECK_MOBILE_BASE,"mobile验证失败");
        error_detail_map.put(ErrorCodeDef.RET_NEW_MAIL_BASE,"新邮箱不能与旧邮箱相同");
        error_detail_map.put(ErrorCodeDef.RET_CHECK_MAIL_BASE,"旧邮箱验证失败");
        //////////////////////////////////////user end///////////////////////////////////////
        ...
        error_detail_map.put(ErrorCodeDef.RET_FRIEND_MAXCNT_ERROR,"你已达到好友上限");
        error_detail_map.put(ErrorCodeDef.RET_FRIEND_PEERMAXCNT_ERROR,"对方好友达到上限");
        ...
        error_detail_map.put(ErrorCodeDef.RET_GROUP_MAX_LIMIT_ERROR,"群人数已上限");
        error_detail_map.put(ErrorCodeDef.RET_GROUP_SINGLE_LIMIT_ERROR,"单次拉人上限");
        error_detail_map.put(ErrorCodeDef.RET_GROUP_MODIFY_REMARK_ERROR,"修改群公告失败");
        ...
        error_detail_map.put(ErrorCodeDef.RET_GROUP_REPEATED_PACK,"收到重发群信息包");
        //////////////////////////////////////group end///////////////////////////////////////
        ...
        //////////////////////////////////////business start//////////////////////////////////////
        error_detail_map.put(ErrorCodeDef.RET_MOMENTS_ARTICLE_SAVED_ERROR,"朋友圈保存异常，请稍后再试!");
        error_detail_map.put(ErrorCodeDef.RET_MOMENTS_ARTICLE_DELETED_ERROR,"朋友圈删除异常，请稍后再试!");
        error_detail_map.put(ErrorCodeDef.RET_MOMENTS_ARTICLE_QUERY_ERROR,"没有找到信息，请稍后再试!");
