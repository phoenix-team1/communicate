...
public final class S_MSG extends Table {
  ...
  public static S_MSG getRootAsS_MSG(ByteBuffer _bb, S_MSG obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public S_MSG __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public long msgTime() { int o = __offset(18); return o != 0 ? bb.getLong(o + bb_pos) : 0L; }
  ...
  public static void addMsgTime(FlatBufferBuilder builder, long msgTime) { builder.addLong(7, msgTime, 0L); }
