...
public final class T_EC_GETPROMPTS_RQ extends Table {
  public static T_EC_GETPROMPTS_RQ getRootAsT_EC_GETPROMPTS_RQ(ByteBuffer _bb) { return getRootAsT_EC_GETPROMPTS_RQ(_bb, new T_EC_GETPROMPTS_RQ()); }
  public static T_EC_GETPROMPTS_RQ getRootAsT_EC_GETPROMPTS_RQ(ByteBuffer _bb, T_EC_GETPROMPTS_RQ obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public T_EC_GETPROMPTS_RQ __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void startT_EC_GETPROMPTS_RQ(FlatBufferBuilder builder) { builder.startObject(2); }
  ...
  public static int endT_EC_GETPROMPTS_RQ(FlatBufferBuilder builder) {
    int o = builder.endObject();
    return o;
  }
  public static void finishT_EC_GETPROMPTS_RQBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset); }
}
