...
public final class T_FRIEND_LIST_RS extends Table {
  ...
  public static T_FRIEND_LIST_RS getRootAsT_FRIEND_LIST_RS(ByteBuffer _bb, T_FRIEND_LIST_RS obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public T_FRIEND_LIST_RS __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public friendpack.T_FREIND_INFO friendList(friendpack.T_FREIND_INFO obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
