...
public final class T_GROUP_BASE_REQUEST extends Table {
  ...
  public static T_GROUP_BASE_REQUEST getRootAsT_GROUP_BASE_REQUEST(ByteBuffer _bb, T_GROUP_BASE_REQUEST obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public T_GROUP_BASE_REQUEST __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
