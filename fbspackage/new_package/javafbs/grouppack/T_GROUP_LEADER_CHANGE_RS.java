...
public final class T_GROUP_LEADER_CHANGE_RS extends Table {
  public static T_GROUP_LEADER_CHANGE_RS getRootAsT_GROUP_LEADER_CHANGE_RS(ByteBuffer _bb) { return getRootAsT_GROUP_LEADER_CHANGE_RS(_bb, new T_GROUP_LEADER_CHANGE_RS()); }
  public static T_GROUP_LEADER_CHANGE_RS getRootAsT_GROUP_LEADER_CHANGE_RS(ByteBuffer _bb, T_GROUP_LEADER_CHANGE_RS obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public T_GROUP_LEADER_CHANGE_RS __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void startT_GROUP_LEADER_CHANGE_RS(FlatBufferBuilder builder) { builder.startObject(3); }
  ...
  public static int endT_GROUP_LEADER_CHANGE_RS(FlatBufferBuilder builder) {
    int o = builder.endObject();
    return o;
  }
  public static void finishT_GROUP_LEADER_CHANGE_RSBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset); }
}
