...
public final class T_GROUP_LIST_IDS_RS extends Table {
  ...
  public static T_GROUP_LIST_IDS_RS getRootAsT_GROUP_LIST_IDS_RS(ByteBuffer _bb, T_GROUP_LIST_IDS_RS obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public T_GROUP_LIST_IDS_RS __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public grouppack.T_GROUP_RELATION_USER_INFO groupInfoList(grouppack.T_GROUP_RELATION_USER_INFO obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
