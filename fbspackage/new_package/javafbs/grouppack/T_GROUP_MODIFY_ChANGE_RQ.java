...
public final class T_GROUP_MODIFY_ChANGE_RQ extends Table {
  public static T_GROUP_MODIFY_ChANGE_RQ getRootAsT_GROUP_MODIFY_ChANGE_RQ(ByteBuffer _bb) { return getRootAsT_GROUP_MODIFY_ChANGE_RQ(_bb, new T_GROUP_MODIFY_ChANGE_RQ()); }
  public static T_GROUP_MODIFY_ChANGE_RQ getRootAsT_GROUP_MODIFY_ChANGE_RQ(ByteBuffer _bb, T_GROUP_MODIFY_ChANGE_RQ obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public T_GROUP_MODIFY_ChANGE_RQ __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void startT_GROUP_MODIFY_ChANGE_RQ(FlatBufferBuilder builder) { builder.startObject(3); }
  ...
  public static int endT_GROUP_MODIFY_ChANGE_RQ(FlatBufferBuilder builder) {
    int o = builder.endObject();
    return o;
  }
  public static void finishT_GROUP_MODIFY_ChANGE_RQBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset); }
}
