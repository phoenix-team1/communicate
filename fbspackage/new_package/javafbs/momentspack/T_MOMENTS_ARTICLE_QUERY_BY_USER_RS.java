...
public final class T_MOMENTS_ARTICLE_QUERY_BY_USER_RS extends Table {
  public static T_MOMENTS_ARTICLE_QUERY_BY_USER_RS getRootAsT_MOMENTS_ARTICLE_QUERY_BY_USER_RS(ByteBuffer _bb) { return getRootAsT_MOMENTS_ARTICLE_QUERY_BY_USER_RS(_bb, new T_MOMENTS_ARTICLE_QUERY_BY_USER_RS()); }
  public static T_MOMENTS_ARTICLE_QUERY_BY_USER_RS getRootAsT_MOMENTS_ARTICLE_QUERY_BY_USER_RS(ByteBuffer _bb, T_MOMENTS_ARTICLE_QUERY_BY_USER_RS obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public T_MOMENTS_ARTICLE_QUERY_BY_USER_RS __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void startT_MOMENTS_ARTICLE_QUERY_BY_USER_RS(FlatBufferBuilder builder) { builder.startObject(2); }
  ...
  public static int endT_MOMENTS_ARTICLE_QUERY_BY_USER_RS(FlatBufferBuilder builder) {
    int o = builder.endObject();
    return o;
  }
  public static void finishT_MOMENTS_ARTICLE_QUERY_BY_USER_RSBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset); }
}
