...
public final class T_OFFLINE_MESSAGE extends Table {
  ...
  public static T_OFFLINE_MESSAGE getRootAsT_OFFLINE_MESSAGE(ByteBuffer _bb, T_OFFLINE_MESSAGE obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public T_OFFLINE_MESSAGE __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
