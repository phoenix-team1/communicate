...
public final class T_CHAT_GET_OFFLINE_MESSAGE_RQ extends Table {
  ...
  public static T_CHAT_GET_OFFLINE_MESSAGE_RQ getRootAsT_CHAT_GET_OFFLINE_MESSAGE_RQ(ByteBuffer _bb, T_CHAT_GET_OFFLINE_MESSAGE_RQ obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public T_CHAT_GET_OFFLINE_MESSAGE_RQ __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
