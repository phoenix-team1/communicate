...
public final class T_GET_MSG_UNREAD_RQ extends Table {
  public static T_GET_MSG_UNREAD_RQ getRootAsT_GET_MSG_UNREAD_RQ(ByteBuffer _bb) { return getRootAsT_GET_MSG_UNREAD_RQ(_bb, new T_GET_MSG_UNREAD_RQ()); }
  public static T_GET_MSG_UNREAD_RQ getRootAsT_GET_MSG_UNREAD_RQ(ByteBuffer _bb, T_GET_MSG_UNREAD_RQ obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public T_GET_MSG_UNREAD_RQ __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static void startT_GET_MSG_UNREAD_RQ(FlatBufferBuilder builder) { builder.startObject(2); }
  ...
  public static int endT_GET_MSG_UNREAD_RQ(FlatBufferBuilder builder) {
    int o = builder.endObject();
    return o;
  }
  public static void finishT_GET_MSG_UNREAD_RQBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset); }
}
