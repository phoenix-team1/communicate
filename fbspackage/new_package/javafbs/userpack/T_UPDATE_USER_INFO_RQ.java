...
public final class T_UPDATE_USER_INFO_RQ extends Table {
  ...
  public static T_UPDATE_USER_INFO_RQ getRootAsT_UPDATE_USER_INFO_RQ(ByteBuffer _bb, T_UPDATE_USER_INFO_RQ obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public T_UPDATE_USER_INFO_RQ __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public T_KEYINFO keyLstInfo(T_KEYINFO obj, int j) { int o = __offset(6); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
