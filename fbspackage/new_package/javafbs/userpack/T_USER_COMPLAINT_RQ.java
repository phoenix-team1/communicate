...
public final class T_USER_COMPLAINT_RQ extends Table {
  ...
  public static T_USER_COMPLAINT_RQ getRootAsT_USER_COMPLAINT_RQ(ByteBuffer _bb, T_USER_COMPLAINT_RQ obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public T_USER_COMPLAINT_RQ __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
