...
public final class T_USER_COMPLAINT_RS extends Table {
  ...
  public static T_USER_COMPLAINT_RS getRootAsT_USER_COMPLAINT_RS(ByteBuffer _bb, T_USER_COMPLAINT_RS obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { bb_pos = _i; bb = _bb; }
  public T_USER_COMPLAINT_RS __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
